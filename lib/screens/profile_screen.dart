...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _showEditProfile() async {
    final currentName = (userData?['name'] ?? '').toString();
    final currentPhone = (userData?['phone'] ?? '').toString();
    ...
    try {
      await _authService.updateProfile(name: updatedName, phone: updatedPhone);
      if (!mounted) {
        return;
      }
      await _loadUserData();
